    ...
    return (
        <section onClick={() => navigate(`/p/${project._id}`)} className='bg-slate-500 p-4 rounded-xl flex flex-col gap-2 h-fit'>
            ...
            <div className='flex gap-2'>
                <span className='bg-purple-400 rounded-full text-sm py-0.5 px-3'>Tecnologia</span>
                <span className='bg-purple-400 rounded-full text-sm py-0.5 px-3'>Linguagem</span>
                <span className='bg-purple-400 rounded-full text-sm py-0.5 px-3'>Framework</span>
            </div>
            <p>
                {description}
            </p>
