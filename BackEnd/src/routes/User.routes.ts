...
import { getAllUsers, getUser, createUser, deleteUser, updateUser, getProjects } from '../controllers/User.controllers';
...
userRouter.get('/:id/projects', getProjects);   // GET      https://monkeycodeapiserver.onrender.com/users/1/projects -> mostra os projetos do usuário com id 1